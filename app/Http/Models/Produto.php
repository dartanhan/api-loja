...
class Produto extends Model
{
    ...
    protected $fillable = ['codigo_produto','descricao','status','valor_produto','valor_dinheiro','valor_cartao','percentual','fornecedor_id','categoria_id','cor_id','ncm','cest','origem_id'];
