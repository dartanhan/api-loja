                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-auto input-group-sm">
                            <h5 class="title"><i class="bi bi-file-earmark-spreadsheet"></i><strong> {{ __('Tabela NCM') }}</strong></h5>                          
                        </div>
                ...
                <div class="card-body">
                    <table id="table" class="table compact table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th data-sortable="true">Nome/Descrição</th>
    ...
    <div class="modal fade" id="divModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form method="post" autocomplete="off" id="formNcm" name="formNcm" enctype="multipart/form-data" action="{{route('ncm.store')}}" novalidate="validate">
                    @csrf
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="metodo" id="metodo">
                    <div class="modal-header bg-pink text-white">
                        <h5 class="modal-title" id="title-ncm"> </h5>
                        ...
                        <div class="form-row">
                            <div class="form-group col-xs-1">
                                <span class="border-lable-flt">
                                    <input type="text" class="form-control" placeholder="NÚMERO DO NCM" name="numero" id="numero" required>
                                    <label for="label-numero">NÚMERO NCM</label>
                                </span>
                            </div>
                            <div class="form-group col-md-8">
                                <span class="border-lable-flt">
                                    <input type="text" class="form-control" placeholder="NOME / DESCRIÇÃO" name="nome" id="nome" required>
                                    <label for="label-nome">NOME / DESCRIÇÃO</label>
                                </span>
                            </div>
                        </div>
                    </div>
...
@push("scripts")
    ...
    <script src="{{URL::asset('js/ncm.js')}}"></script>
@endpush
@push("styles")
